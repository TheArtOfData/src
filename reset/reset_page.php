...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <div class="wrapper-login">
        ...
        <div class="login100-pic" >
          ...
          <form class="" id="user_reset"><br>
            ...
            <input type="password" class=" login-100-text"  placeholder="Password" id="psw"><br>
            <input type="password" class=" login-100-text"  placeholder="Re-enter Password" id="psw2">
    ...
    echo '<script type="text/javascript">',
         ...
         '</script>';
    ?>
    <script src="../js/user/reset.js" charset="utf-8"></script>
    <script>
    $('.js-tilt').tilt({
      scale: 1.1
    })
